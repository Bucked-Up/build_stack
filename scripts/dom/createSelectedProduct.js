...
const createSelectedProduct = ({ prod, value }) => {
  ...
  removeButton.innerHTML = '<svg viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="3.75781" y="4.81812" width="2" height="11" transform="rotate(-45 3.75781 4.81812)" fill="white"/><rect x="11.5371" y="3.40381" width="2" height="11" transform="rotate(45 11.5371 3.40381)" fill="white"/></svg>';
